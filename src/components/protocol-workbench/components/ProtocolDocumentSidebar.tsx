...
export function ProtocolDocumentSidebar({
  ...
  return (
    <div className="space-y-6">
      {/* AI Validation Status - NEW */}
      <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
        <div className="flex items-center gap-2 mb-3">
          <Shield className="w-5 h-5 text-purple-600" />
          <h3 className="font-semibold text-purple-900">AI Validation</h3>
          <Sparkles className="w-4 h-4 text-purple-500" />
        </div>
        <div className="space-y-2 text-xs text-purple-700">
          <p className="leading-relaxed">
            The AI Governance Persona continuously validates your protocol for compliance, completeness, and consistency.
          </p>
          <div className="pt-2 border-t border-purple-200 mt-3">
            <p className="font-medium text-purple-900 mb-2">Real-time checks:</p>
